...
De rij van de replicatie wordt periodiek geblokkeerd voor één van onze klanten AEMaaCS. In dit artikel wordt de tijdelijke oplossing beschreven die door het Engineering Team wordt voorgesteld en die in de gebruikersinterface kan worden uitgevoerd met beheerdersmachtigingen.
...
Één van onze AEMaaCS de replicatierij van Klanten periodiek geblokkeerd toe te schrijven aan javax.jcr.NamespaceException: Onbekend namespace prefix: ns22_ uitzondering.
...
Om de rij te ontgrendelen vereist eenvoudig het schrappen van het verzoek van golden-publiceer de rij UI van de distributierij. Stel de klant voor de onderstaande stappen uit te voeren.
