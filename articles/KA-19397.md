...
<b><u>Oorzaak:</u></b>  `con` is een gereserveerd trefwoord in [!DNL Windows]

<b><u>Resolutie:</u></b>

In [!DNL Microsoft Windows], kunt u geen mappen maken of extensies met de onderstaande woorden hebben.

`CON, PRN, AUX, NUL, COM1, COM2, COM3, COM4, COM5, COM6, COM7, COM8, COM9, LPT1, LPT2, LPT3, LPT4, LPT5, LPT6, LPT7, LPT8, and LPT9`

Dit zijn gereserveerde trefwoorden in [!DNL Windows]. Als u een instantie met deze namen een naam geeft, treedt er dus een fout op bij het upgraden naar een map met een instantienaam die in uw systeem is gemaakt.
