...
- Download het jar-bestand dat met een eak wordt uitgevoerd van hier [https://repo1.maven.org/maven2/org/apache/jackrabbit/oak-run/](http://repo1.maven.org/maven2/org/apache/jackrabbit/oak-run/)
