...
<br>In versie 2023.02.11382, zijn sommige verbeteringen aangebracht in de implementatie van GraphQL (Open-Source Query Language) die onverwacht gedrag in de toepassingscode zou kunnen veroorzaken, in het geval wanneer het zich op het onjuiste gedrag van de oudere versies baseerde. 
<br>Met de onderstaande resolutie kunt u bereiken dat Adobe Experience Manager (AEM) GraphQL nu inhoud met null-waarden consistent retourneert voor alle filterbewerkingen. <br><br>
