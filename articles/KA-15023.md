...
Klik op + onder de knop [!UICONTROL Actions] om een nieuw actiepunt te maken. Dit zal als één enkel punt van configuratie voor de variabelen van de opstellings VideoAnalytics dienst doen. Ik heb enkele hard-gecodeerde waarden gebruikt. U kunt echter gegevenselementen gebruiken om deze variabelen te vullen.

1. Selecteren &quot;[!UICONTROL Core]&quot; van [!UICONTROL Extension] vervolgkeuzelijst.
2. Selecteren &quot;[!UICONTROL Custom Code]&quot; van [!UICONTROL Action Type] vervolgkeuzelijst.
...
7. Voeg de code toe en klik op [!UICONTROL Save]. Zorg ervoor dat u de waarden volgens uw bedrijf en rapportsuite bijwerkt.
...
8. Voeg bovenaan de code de volgende code toe en klik op [!UICONTROL Save].
...
Downloaden [!UICONTROL Heartbeat] SDK van [https://github.com/Adobe-Marketing-Cloud/media-sdks/tree/master/sdks/js/libs](https://github.com/Adobe-Marketing-Cloud/media-sdks/tree/master/sdks/js/libs).
...
5. Schakel &quot;Globaal uitvoeren&quot; in.
6. Klik op &quot;[!UICONTROL Open Editor]&quot;.
7. Voeg de volgende code toe en klik op [!UICONTROL Save].
