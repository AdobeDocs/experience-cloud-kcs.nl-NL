...
<br><br><br>Hoe kan ik draaddumps van een JVM op Linux, UNIX of Vensters nemen?<br><br><br><br> <br><br>
...
<br><br>Stap 1: De PID van uw Java-proces ophalen<br><br><br><br> <br><br>
...
<b>Opmerking:</b> In Linux en UNIX, kunt u dit bevel moeten in werking stellen zoals sudo -u gebruiker jps -l, waar &quot;gebruiker&quot;de gebruikersbenaming van de gebruiker is die het proces van Java zoals loopt.
...
- In Linux en UNIX, moet u het bevel als gebruiker in werking stellen die het java proces bezit:
   ...
   sudo-u *java-gebruiker* jstack-l *pid*  
...
- Als de jstack-opdracht (jstack -l pid threaddumps.log) de fout 1 hieronder genereert, voert u de opdracht uit als de gebruiker die eigenaar is van het Java-proces.  Bijvoorbeeld:
...
Voer het als volgt uit: sudo-u *user* jstackSeries.sh *pid* *aemservergebruiker* *aantal* *vertragen*
...
2. Als u CQSE begint gebruikend crx-quickstart/server/start manuscript dan zullen uw draaddumps output aan crx-quickstart/server/logs/startup.log zijn. Als u een server van de derdetoepassing zoals JBoss, WebSphere, Tomcat, of andere gebruikt, zie de documentatie van de server om te weten te komen aan welk dossier de standaardoutput wordt geleid.
...
1. Voeg de volgende parameter aan jvm toe die Communique in werking stelt: - Dcom.sun.management.jmxremote
