---
title: "Voorbeelden van request.log-analyse | AEP"
...
# Voorbeelden van request.log-analyse | AEP
...
De Adobe Experience Manager (AEM) `request.log` bevat diverse nuttige informatie, zoals responstijd, voor het analyseren van de prestatieproblemen. Hier volgt een lijst met analysevoorbeelden met Linux-opdrachten (inclusief enkele externe opdrachten).
...
2. Ontbrekende reactie wordt benaderd
3. Langzame toegang
...
9. access.log verslagen voor een request.log verslag
