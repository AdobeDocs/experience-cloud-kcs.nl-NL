---
title: "Kan Adobe Target niet selecteren als de Cloud-oplossing voor een IMS-configuratie"
...
# Kan Adobe Target niet selecteren als Cloud-oplossing voor een IMS-configuratie
...
Omgeving: AEM op locatie



De klant probeert een Adobe Target IMS-configuratie te maken om AEM met Adobe Target te integreren.

Als ze echter &quot;Adobe Target&quot; selecteren als Cloudoplossing voor de IMS-configuratie, wordt de fout &quot;Kan certificaten niet ophalen: De opgegeven gebruiker-id identificeert geen bestaande gebruiker&quot; weergegeven en kan de configuratie niet worden gemaakt.

Dit probleem doet zich alleen voor bij de Adobe Target-oplossing.



Stappen om te reproduceren:

1. Naar gereedschappen `>`  Beveiliging `>`  IMS-configuraties `>`  Maken
2. Doel selecteren als oplossing

U ontvangt een fout in de interface &quot;Kan certificaat niet ophalen. De opgegeven gebruiker identificeert geen bestaande gebruiker.&quot;

In de logboeken is de enige fout met betrekking tot dit probleem `[` 1`]` .
...
Wanneer het controleren van de toestemmingen voor de gebruikers &quot;doel-imsconfig-dienst&quot;en &quot;doelgetservice&quot;werd opgemerkt dat de doel-imsconfig-dienst geen ACEs toegewezen had.
...
Pad: /home/users/system/target-imsconfig-service

Machtiging: toestaan

Rechten: jcr:read; rep:write
