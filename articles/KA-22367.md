...
Na het creëren van de configuratie van SAML 2.0 om login SSO op hun productieAuteur toe te laten ontvingen de klant een foutenmelding van de AEM nadat de Azure leverancier login uitvoerde en het teken van SAML terughaalde, om de authentificatie op de AEM kant uit te voeren.<br><br> <br><br>De ontvangen fout is `[` 1`]` <br><br> <br><br><b>`[` 1`]`  \*FOUT\* `[` qtp1558388453-153215`]`  De responsparameter com.adobe.granite.auth.saml.SamlAuthenticationHandler SAML is niet opgegeven of is ongeldig.</b>
...
Fout 403 wordt meestal weergegeven als het filter Apache Sling Referrer niet is ingeschakeld. Als u de configuratie voor het filter Apache Sling Reference inschakelt, is de optie &quot;Lege toestaan&quot; niet gecontroleerd en is er ook geen host toegevoegd aan &quot;Hosts toestaan&quot;
...
Na het voltooien van deze vereiste stappen - controleer &quot;Lege toestaan&quot;en het toevoegen van de gastheren die de leverancier IdP aan &quot;Allow Gastheren&quot;vertegenwoordigen login was succesvol.



OPMERKING:

De IDP URL moet aan de configuratie van de Filter van de Verwijzing van Apache worden toegevoegd zonder het protocol - b.v. aem-sso-saml in plaats van https://aem-sso-saml op te nemen
