...
Nochtans, wijst pipeExecutionMisluktRedons op &quot;ASSETS_TESTS_AUTHOR_CONNECTION_ERROR&quot;met een foutencode &quot;002_010_006&quot;en het bericht:

`Unable to connect to the author instance. `
  
De interne details suggereren een de reactiekwestie van HTTP met een bericht erop wijst die &quot;niet Gevonden&quot;wijzen, die typisch zou impliceren dat het eindpunt voor de auteursinstantie niet bereikbaar tijdens de testuitvoering was.
...
De gebruiker van cloudmanager bestaat echter en het handmatig uploaden van elementen naar de auteur werkt naar behoren.

De test van de prestaties van het element werkt 30 minuten en vervolgens mislukt de test plotseling op herhaalde wijze, terwijl de test na 30 minuten moet stoppen - `[` 1`]`
...
Als de interne Azure-functielogboeken worden gecontroleerd, is het verzoek gevonden dat het resultaat 404 Niet gevonden had.

De GET naar de URL vanuit het veld &quot;message&quot; heeft 404 geretourneerd `[` 1`]` .

De mislukking in dit geval werd veroorzaakt door het feit dat de querybuilder op aanbeveling van de Adobe op het niveau van de verzender werd geblokkeerd.

Cloud Manager heeft echter de querybuilder nodig om op de dispatcher voor de cloudmanager-gebruiker te kunnen worden toegelaten, zoals tijdens het testen van het element de verwerkingstijd wordt opgehaald.
