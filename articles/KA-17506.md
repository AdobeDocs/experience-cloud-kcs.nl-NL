...
- Gebruik een vertoningsfilter op de haven van SMS-C.<br>\
   Als SMS-C bijvoorbeeld poort 10000 gebruikt, gebruikt u het volgende filter:
   `tcp.port == 10000`
...
- Gebruik de<b>TCP-stroom volgen</b> om de stream te isoleren waaraan u werkt.<br>\
