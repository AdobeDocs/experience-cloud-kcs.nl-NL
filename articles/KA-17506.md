...
Opmerking: De lijst van standaardbevelen kan in sectie 5.1.2.1 van de specificatie worden gevonden SMPP (de reeks van het Bevel SMPP).
...
<b>Codering van MT</b>
Let op: De codering van SMS is een complex onderwerp met vele vallen en diverse implementaties.
...
Opmerking: Adobe Campaign Classic SMPP-aansluiting kan SR die aankomt vóór de *SUBMIT_SM_RESP* pakket. Dit gedrag is niet expliciet in de specificatie verboden, maar het wordt als slecht gedrag beschouwd (het zou betekenen dat het bericht is ontvangen voordat het is verzonden). Als u dit geval te vaak ontmoet, vraag uw sms-c partner om zijn platform te bevestigen.
