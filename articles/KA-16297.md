---
title: AEM sjabloon ophalen van [!DNL Campaign] console
...
# AEM sjabloon ophalen van [!DNL Campaign] console

## Beschrijving


Probleembeschrijving = bij het synchroniseren van AEM sjablonen naar [!DNL Campaign], wordt de volgende fout gegenereerd:
...
Replicatierechten moeten worden toegekend aan de AEM van de campagne, in AEM server.  We hebben lees-, schrijf- en replicatierechten voor de [!DNL Campaign]AEM gebruiker in het kader van /content/campagne en/content/dam paden waar de campagne-elementen aanwezig waren.
