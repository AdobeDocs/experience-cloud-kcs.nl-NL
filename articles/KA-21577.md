...
<b>Omgeving</b><br><br>Cloud Manager (Adobe Experience Manager)<br><br> <br><br><b>Probleem/symptomen</b>
...
1. Zoek de knooppuntversie die in reactor pom.xml wordt gebruikt. Onder voorbeeld = 16.14.0    `pom.xml`:
...
2. Deze knooppuntversie toevoegen als <b>devDependency</b> in de `package.json` bestand van de module die niet kon worden gemaakt. In het bovenstaande voorbeeld is dit UI Front.    VOOR - `package.json`:
