...
1. Het servicepack installeren
1. Het logbestand voor foutopsporing controleren
...
1. Verwijder zo nodig de configuratie van het logbestand voor foutopsporing
