...
Selecteer &#39;Profielkoppeling apparaatgrafiek&#39; als u wilt doorgaan met het opgeven van apparaatprofielen voor andere apparaten, of &#39;Apparaatprofiel&#39; als u de kwalificatie wilt beperken tot het huidige apparaat. Meer details over de verschillen tussen deze twee opties zijn hier beschikbaar: [https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/profile-merge-rules/merge-rule-definitions.html?lang=en#device-options](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/profile-merge-rules/merge-rule-definitions.html?lang=en#device-options)
...
Als u wilt dat de copop-optie uit de gebruikersinterface wordt verwijderd, past u uw PMR&#39;s aan zoals hierboven beschreven en opent u vervolgens een ticket voor de klantenservice met het verzoek om het apparaatco-op te verwijderen. Ook kunt u een ticket openen met algemene vragen of zorgen over dit artikel of de algemene afleiding van het apparaat. U kunt ook onze veelgestelde vragen raadplegen voor meer informatie: [https://experienceleague.adobe.com/docs/device-co-op/using/about/device-co-op-eol.html?lang=en](https://experienceleague.adobe.com/docs/device-co-op/using/about/device-co-op-eol.html?lang=en)
