---
title: Hoe te om de indexen van de Luzern van het Eak te optimaliseren om indexatietijd te verminderen
...
- `includedPaths` en `excludedPaths` eigenschappen beperken welke paden de index bij het opnieuw indexeren doorloopt en naar welke paden deze luistert voor indexupdates.
...
3. Voeg de eigenschappen die onder 1 worden gemarkeerd toe aan de corresponderende indexen. De` includedPaths `en` excludedPaths `eigenschappen moeten `multi-value String (String)`.
