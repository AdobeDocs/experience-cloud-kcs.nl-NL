...
- `/etc/httpd/conf.d/available_vhosts/`
   - In deze map worden al uw VirtualHost / de bestanden die worden opgeroepen, gehost `.vhost`
...
Ook hier zult u zien dat we bestanden en modules hebben toegevoegd, maar geen originele bestanden hebben gewijzigd.  Dit geeft ons de gewenste functionaliteit en beschermt ons tegen ontbrekende gewenste reparaties en houdt aan het hoogste niveau van verenigbaarheid met elke verbetering van het pakket.
