---
title: "[!UICONTROL File collector] alternatief voor activiteit in ACS"
...
# [!UICONTROL File collector] alternatief voor activiteit in ACS

## Beschrijving

Aangezien wij niet over de [!UICONTROL File collector] activiteit in ACS, kunt u het bouwen gebruikend de volgende activiteiten en u zult meer of minder zelfde functionaliteit krijgen
...
De [!UICONTROL File collector] Hiermee kunnen meerdere bestanden worden gedownload op basis van een bestandspatroon van een externe server. Elk bestand wordt doorgegeven aan het [!UICONTROL Load file] activiteit, gegevens in de update geven.
Nadat de bewerking is voltooid, gaat deze door met het volgende bestand, enzovoort.
De bestandsoverdracht heeft ook de [!UICONTROL Historization settings], zoals u weet [!UICONTROL File collector].
