...
1. Kunnen wij indexen op de inheemse lijsten van de Campagne veranderen?
2. Kunnen we een geclusterde index maken?
3. Kan de gegroepeerde index vanuit schemadefinitie worden toegevoegd


## Resolutie


1. Ja, staat de Campagne u toe om niet-gegroepeerde indexen van backend tot stand te brengen. Het enige verschil zal zijn dat dergelijke indexen niet op schemaniveau beschikbaar zullen zijn om wijzigingen aan te brengen. 
...
3. Nee, omdat Campagne alleen het maken van een unieke index toestaat. Geclusterde index moet worden gemaakt op basis van de achtergrond.
