...
description: Ontdek het ingewikkelde proces van cachelroodheid en activering van inhoud, waardoor u naadloze updates en optimale prestaties van uw systeem krijgt.
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager
keywords: KCS, het het flushing mechanisme van het Geheime voorgeheugen, de werkschema van de Verzender, de agenten van de Replicatie, het proces van de Activering, het afhandelen van het verzoek van de flush, het type van de Rang, de configuratie van de Verzender, de methode van HTTP voor het spoelen verzoeken, Stat dossierstructuur, Tijdstempelhandshake, de voorbeelden van de Handdruk van het Geheime voorgeheugen, de dossiermontages van het Farm
...
<br><br>Hoe werkt het<br>
<b>Bewerkingsvolgorde</b>

De typische werkstroom wordt het best beschreven wanneer de inhoudsauteurs een pagina zullen activeren, wanneer de uitgever de nieuwe inhoud ontvangt het een spoelverzoek aan de verzender zoals aangetoond in het volgende diagram teweegbrengt:![](assets/___c36d65be-9217-ef11-9f8a-6045bd006793___.png)
...
<br><br><br><br>Farm File Settings<br><br><br><br>
