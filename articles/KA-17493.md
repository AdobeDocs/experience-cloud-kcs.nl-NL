...
![Scherm van een standaard replicatieagent die toont dat de replicatieagent met reactie en trekker wanneer de nieuwe punten van een replicatiegebeurtenis van de auteur het publiceren inhoud zijn ontvangen](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/disp-flush-agent4.png "disp-flush-agent4")
