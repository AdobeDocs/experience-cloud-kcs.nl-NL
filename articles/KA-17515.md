...
Dit document bevat algemene aanbevelingen voor Adobe Campaign Classic v7-implementatie in uw on-premise datacenter of gevirtualiseerde cloud-omgeving. Dit soort plaatsing, die als hybride of midsourcing wordt bedoeld, plaatst de de marketing van de Campagne instantie en marketing gegevensbestand onder uw operationeel controle, terwijl het gebruiken van de Diensten van het Overseinen van de Wolk van de Adobe om e-mail, SMS of SMPP berichten te verzenden, en e-mail open te verzamelen, stuitert, en het volgen gegevens klikt.<br><br>De marketinginstantie is het deel van de Adobe Campaign-architectuur dat alle marketingactiviteiten stuurt en alle gegevens van de ontvanger en de analytische gegevens opslaat die door campagnes worden geretourneerd. De marketinginstantie is een set on-premise servers waarop Adobe Campaign-services worden uitgevoerd, en een relationele database.
...
Dit artikel is alleen beschikbaar als algemene voorbeeldgids. U moet contact opnemen met uw Adobe Campaign Customer Success Manager om de exacte grootte van uw implementatie te meten voordat u uw Campagne-project start. <b>Niet gebruiken</b> infrastructuur of hardware aanschaffen of implementeren totdat dit gebeurt.

Dit document bevat algemene aanbevelingen voor Adobe Campaign Classic v7-implementatie in uw on-premise datacenter of gevirtualiseerde cloud-omgeving. Dit soort inzet, waarnaar wordt verwezen als <b>hybride</b> of <b>midsourcing</b>, plaatst de marketinginstantie en de marketingdatabase van Campagne onder uw controle en gebruikt u de services van Cloud Messaging van Adobe om e-mails, SMS- of SMPP-berichten te verzenden en e-mail te verzamelen, open te stuiteren en te klikken op trackinggegevens.
...
<br>Scenarios<br>
De diagrammen van de plaatsing en de aanbevelingen van de hardwaregrootte worden verstrekt voor drie representatieve scenario&#39;s:Veronderstellingen
...
<br>Scenario 1: Moderne-Grootte scenario-1 van de Plaatsing<br>
Geraamd volume:
...
Maximale dagelijkse e-mailvolume
...
<br>Web- en toepassingsservers<br>
...
<br>Scenario 2: scenario-2 van de Plaatsing op grote grootte<br>
Geraamd volume:
...
<br>Scenario 3: De Plaatsing van de onderneming met scenario-3 van het Centrum van het Bericht<br>
Geraamd volume:
...
108 miljoen per maand

Direct mail

25 miljoen per maand
...
Het verkeer van de Webtoepassing van de campagne wordt verpletterd aan de Webservers van de Campagne, zodat de uitbarstingen van Webverkeer na grote campagnelanceringen niet de werkschema&#39;s van de Campagne en de gebruikers van de Console van de Cliënt beïnvloeden.
...
<br>Richtlijnen voor het wijzigen van veronderstellingen<br>
...
- <b>Bewaarperiode van gegevens bijhouden</b>
