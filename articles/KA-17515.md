...
<b>*Voorzichtigheid -</b> Dit artikel is alleen beschikbaar als algemene voorbeeldgids. U moet contact opnemen met uw Adobe Campaign Adobe Account Team om de exacte grootte van uw implementatie te meten voordat u uw Campagne-project start. Verkrijg of stel geen infrastructuur of hardware tot dit wordt gedaan.*
...
<b>*Voorzichtigheid -</b> De informatie in dit document is niet van toepassing als u een volledig gehoste Adobe Campaign-instantie gebruikt (geïmplementeerd in Adobe Cloud Servicen).*
...
<u>Scenario 1: Moderne Plaatsing</u>
...
<b>*Voorzichtigheid - </b><b>In deze schatting zijn geen aanvullende klantgegevens opgenomen. Als u van plan bent om extra kolommen of lijsten van klantengegevens in het gegevensbestand van Adobe Campaign te herhalen, dan moet u de extra behoefte van de schijfruimte voor het schatten. Geüploade segmenten/lijsten vereisen ook meer opslag, afhankelijk van hun grootte, frequentie en retentieperiode.*
...
<u>Scenario 2: grootschalige implementatie</u>
...
Zie [Scenario 1: Moderne Plaatsing](https://experienceleague.adobe.com/docs/campaign-classic/using/technotes/hardware-sizing.html?lang=en#scenario-1) voor meer opmerkingen over proxy&#39;s, voorkeurscentra/abonnementsafhandeling en schijfruimtegebruik.
<br> <br></b>Database<b>
De aanbevelingen van de hardware voor de gegevensbestandserver zijn als volgt:
...
<u>Scenario 3: Implementatie voor bedrijven met Message Center</u>
