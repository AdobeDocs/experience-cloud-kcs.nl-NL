...
description: "Leer hoe u algemene indexeringsproblemen met Adobe Experience Manager kunt oplossen."
...
In niet-productiemilieu&#39;s, kan het de hulpmiddelpakket van de Diensten van de Raadpleging van de Adobe (ACS) worden geïnstalleerd om een verklarend vraaghulpmiddel voor het verdere zuiveren te verstrekken.
...
- Tijdens het opnieuw indexeren wordt het dialoogvenster *status* kenmerk van IndexStatsMBean zou waarde hebben *uitvoeren*.
...
- U kunt bevestigen dat het indexeren voltooid door uw knoop van de indexdefinitie te controleren, de bezit herdexCount zou moeten zijn verhoogd en de herindexbooleaanse zou moeten worden geplaatst aan *false*.
...
6. Ga naar deze URL `/system/console/configMgr/org.apache.jackrabbit.oak.plugins.index.lucene.LuceneIndexProviderService` *Kopiëren bij lezen*, *Kopiëren bij schrijven*(alleen veilig voor gebruik in Eak 1.0.18 en hoger) en &quot;Prefetch-indexbestanden&quot; (alleen in Eak 1.0.18 en hoger)
