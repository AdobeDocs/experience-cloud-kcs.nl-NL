---
title: "Pipeline mislukt met fout \"De eigenschap end_aem_createsegmentstore ontbreekt\""
...
# Pipeline mislukt met fout &quot;De eigenschap end_aem_createsegmentstore ontbreekt&quot;

## Beschrijving {#description}

De CI/CD pijpleiding blijft ontbreken tijdens het &quot;opstellen aan Dev&quot;stadium. <br><br>De plaatsingslogboeken toonden geen fout toe te schrijven aan de codebasis maar de volgende fouten zijn aanwezig:<br><br> <br><br> <br><br> <br><br>`[` 1`]`  
...
Wanneer de pijplijn wordt gecontroleerd, kan worden gezien dat deze mislukt met de fout &quot;errorCode&quot;: &quot;BLOCKED_QUEUE&quot;.

Dit betekent dat de replicatiewachtrij wordt geblokkeerd, waardoor de installatie van extra veranderbare inhoud wordt belemmerd.

In de logboeken, de fouten `[` 1`]`  aanwezig zijn tijdens de implementatieperiode. De meest waarschijnlijke knoop - `[` 2`]`  is niet aanwezig op de uitgever en/of voorproefserver en de replicatie ontbreekt.
...
`[` 2`]`  /content/parent_site/main_page/global/main/nl/page_1/page_2/page_3/page_4/page_5
