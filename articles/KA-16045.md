...
Na integratie SDK5, bereikt de vraag van de Registratie niet de instantie ACS.


## Resolutie


De functie &quot;Campaign.registerExtension();&quot; is niet geïmplementeerd in de IOS App, wat tot deze uitgave heeft geleid.

Zie ter referentie: [https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-campaign-standard](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-campaign-standard)
