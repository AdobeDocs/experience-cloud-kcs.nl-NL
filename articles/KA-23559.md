---
title: "Fout bij het maken van een ditamap"
description: "Er wordt een fout weergegeven bij het maken van een ditamap"
...
# Fout bij maken van ditamap

## Beschrijving {#description}


Wanneer u een ditamap maakt, wordt de volgende fout op het scherm weergegeven, ook al is de ditamap gemaakt.
...
Ga als volgt te werk om de aanmaakfout van ditamap op te lossen:

1. Navigeren naar <b>Gereedschappen `>`  Hulplijnen `>`  Documentstatussen</b> in de AEM interface.
