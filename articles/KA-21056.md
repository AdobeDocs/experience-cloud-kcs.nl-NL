...
1. In uw code, identificeer volgende functie en verwijder hen:
   ...
   4. GA.submitUniversalAnalytics(); OF GA.submitUniversalAnalytics();  `[` Als u gegevens aan Google Analytics door:sturen`]`
2. Nadat u de bovenstaande functie hebt verwijderd, moet u ook de DIL JS-bibliotheek uit de code verwijderen.


<b>Resultaat</b>: Uw website opnieuw publiceren en opnieuw laden, u zou geen vraag als https://subdomain.demdex.net/event moeten zien?.....
