...
De klant beschikt over de AEM omgeving die is ingesteld met de twee auteurs, uitgevers en verzenders. Er is één Actieve en één Reserve auteur en de uitgevers en de verzenders zijn in hoge beschikbaarheid.
...
Na deze verrichting kon de klant tot secundaire toegang hebben. Toen alles goed was, werden de auteurs teruggezet zoals voorheen.

Dezelfde procedure werd nog eens geprobeerd, de volgende dag werd de secundaire auteur ingeschakeld, maar was niet toegankelijk vanwege het gebrek aan beschikbare certificaten die eerder werden geïmporteerd
...
Deze fout verschijnt gewoonlijk wanneer de crypto eigenschap op de instantie wordt gebroken en in dit geval, moet de sleutel HMAC van de instantie worden gesynchroniseerd vanwaar de certificaten werden ingevoerd.
