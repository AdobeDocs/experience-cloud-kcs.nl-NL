...
<br><br><br><br><br> <br><br>
Zie hoe de <b>`DispatcherLogLevel`</b> richtlijn heeft een variabele `DISP_LOG_LEVEL` in plaats van de normale waarde zou je daar zien.  Boven die sectie van code zult u ook een omvat verklaring aan een veranderingendossier zien.  Variabel bestand *`/etc/httpd/conf.d/variables/ams_default.vars`*is waar wij volgende willen kijken.  Hier volgt de inhoud van het variabelenbestand:
<br><br><br><br><br> <br><br><br><br>
...
<br><br><br><br><br> <br><br>
Als u de huidige waarde van `DISP_LOG_LEVEL` variable is info.  We kunnen dit aanpassen om te traceren of fouten op te sporen, of de getalwaarde/het niveau van uw keuze.  Nu elke waar dat het logboekniveau controleert automatisch zal aanpassen.
...
<br><br><br><br><br> <br><br>
Nu weet apache webserver dat domein iets is waarvoor verkeer moet worden opgewekt, maar we moeten de verzendingsmodule nog steeds informeren dat het een nieuwe domeinnaam heeft die moet worden gerespecteerd.  We beginnen met het maken van een nieuwe \*`_vhost.any` file <b>`/etc/httpd/conf.dispatcher.d/vhosts/weretail_vhosts.any`</b> en in dat bestand plaatsen we de domeinnaam die we willen respecteren:
<br><br><br><br><br> <br><br><br><br>

`we-retail.adobe.com`

<br><br><br><br><br> <br><br>
Nu moeten we een nieuw landbouwdossier maken dat ons nieuwe landbouwdossier zal gebruiken `vhost` en we beginnen met het kopiëren van een sterk beginbestand naar ons eigen nieuwe.
<br><br><br><br><br> <br><br><br><br>
