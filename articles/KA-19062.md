...
2. Gebruik de de looppasconsole van het Eak en laad het childCount groovy manuscript om de corrupte knopen in de segmentopslag te identificeren:
   ...
   In sommige gevallen, is de kwestie verbonden met binaire eigenschappen en het childCount groovy manuscript kan van geen bedorven knopen de plaats bepalen.  In deze gevallen, kunt u het volgende bevel in plaats daarvan gebruiken, dat de eerste 1024 bytes voor elk binair getal zal lezen dat tijdens het reizen wordt ontmoet (Gelieve te merken op dit bevel zal langzamer zijn en zou slechts moeten worden gebruikt wanneer hierboven niet de verwachte resultaten terugkeert):
