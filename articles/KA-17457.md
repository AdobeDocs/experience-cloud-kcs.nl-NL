...
<b>Problemen met AEM Sites-prestaties</b>
...
2. Schakel op het niveau van het besturingssysteem in als het AEM Java-proces leidt tot een hoog CPU-gebruik:        Als AEM een hoog CPU-gebruik veroorzaakt, voert u het hulpprogramma voor het maken van profielen een paar minuten uit en analyseert u het resultaat.
...
4. Controleer uw procedures voor systeemonderhoud. Zie dit [artikel](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/monitoring-and-maintaining.html)r voor meer informatie over AEM onderhoud en zorg ervoor dat u het juiste onderhoud uitvoert op AEM waaronder:
...
<br> <b>Problemen met prestaties van middelen</b><br> 
...
<b>Probleem met indexering AEM</b>
...
1. Open deze URL&#39;s op uw AEM-instantie om statistische gegevens over de Async-index weer te geven: http://aemhost:port/system/console/jmx/org.apache.jackrabbit.oak%3Aname%3Dasync%2Ctype%3DIndexStats http://aemhost:port/system/console/jmx/org.apache.jackrabbit.oak%3Aname%3Dfulltext-async%2Ctype%3DIndexStats  - This URL is alleen van toepassing op AEM6.2 en hoger
