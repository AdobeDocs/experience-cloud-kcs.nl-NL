---
title: "De grootte van een gebied van de verzoekkopbal overschrijdt servergrens"
description: "Leer hoe u de fout \"Onjuiste aanvraag\" oplost bij het openen van een pagina in AEM."
solution: Experience Manager as a Cloud Service,Experience Manager
product: Experience Manager as a Cloud Service,Experience Manager
applies-to: "Experience Manager as a Cloud Service,Experience Manager"
keywords: "KCS, size, request header, overtreffen, serverlimiet, AEM, Adobe Experience Manager, Problemen oplossen, AEMaaCS, Adobe Experience Manager as a Cloud Service"
...
# Grootte van een aanvraagheaderveld overschrijdt serverlimiet


De waarde verhogen voor `#LimitRequestFieldSize` en `#LimitRequestLine` voor AMS/On-Premises versies. Verhoog de <b>Aanvraagkop</b> door die eigenschappen ook toe te voegen in de Vhost-bestanden voor AEMaaCS.
...
Wanneer gebruikers een pagina openen, ontvangen ze een &quot;<b>Ongeldig verzoek</b>&quot;response with the message:

&quot;<b>*Grootte van een aanvraagheaderveld overschrijdt serverlimiet</b>*&quot;
...
Apache has a default `LimitRequestLine` of *8K*. Raadpleeg voor meer informatie [Basisfuncties van Apache: LimitRequestLine Directive](https://httpd.apache.org/docs/2.4/en/mod/core.html#limitrequestline) op de Apache-website.

Deze fout kan worden verholpen door de waarde voor `#LimitRequestFieldSize` en `#LimitRequestLine`.

<u>Voor AMS/On-Prem</u>:

De headerlimiet kan worden verhoogd in Apache config-bestand - `httpd.conf`.



<u>Voor AEMaaCS</u>:

Verhoog de limiet voor de aanvraagkoptekst door de bovenstaande eigenschappen toe te voegen in de Vhost-bestanden:
