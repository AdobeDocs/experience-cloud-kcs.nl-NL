---
title: "Handleiding voor technische uitvoering: Audience Manager met campagne"
...
Deze handleiding voor technische integratie is bedoeld voor Adobe Consultants, Adobe Partners en andere ervaren implementatiespecialisten.
...
8. Adobe Campaign v6 moet zijn verbonden met de Marketing-Cloud
...
3. Gegevensbronnen, bestemmingen in AAM UI, en AAM sFTP zouden moeten worden gecreeerd/provisioned door uw vertegenwoordiger van Adobe.
...
Dit moet een lijst van e-mailadressen zijn, gecombineerd met een unieke gehakt identiteitskaart van deze klant.
...
De sFTP-gegevens worden geleverd door de Adobe Customer Care of uw Adobe-medewerker.
...
Er moeten twee gegevensbronnen worden gecreëerd: één gebaseerd op Marketing Cloud ID, en andere gebaseerd op Verklaarde identiteitskaart
...
In Adobe Campaign UI worden twee gegevensbronnen gemaakt: een op gedeclareerde id of gehashte klant-id en een andere op basis van de marketingcloud-id of de aanvraag-UUID.

De doel-id die overeenkomt met elke id, wordt toegevoegd in de desbetreffende velden.

Bijvoorbeeld: de bestemmingsID voor AAM bestemming Adobe Campaign - Verklaarde identiteitskaart wordt toegevoegd in het datasource plaatsen met verzoeningssleutel zoals gehakt klant ID.
...
Ook hebben we verzekerd dat zowel Audience Manager als Campagne de gebruikers met dezelfde gebruikers verzamelen `CRM_ID`.
...
Er moeten twee gedeelde doelgroepen worden gemaakt op basis van MID en de id moet binnen de campagne worden opgegeven.
...
Onder <b>Beheer</b> menuoptie in de campagne-interface, selecteert u <b>Productie</b><b>Technische workflows</b>.

Klik op nieuwe technische werkschema&#39;s, sleep vraag, werk dan gedeeld publiek bij, en eind dan.
...
Zodra gecreeerd, verschijnen deze segmenten automatisch in AAM UI, onder <b>Treinen</b><b>Alle sporen</b><b>Adobe Campaign Traits</b>.
