...
4. [Gems-webinar-sessie over functies voor het verzenden, gebruik en beveiliging van CDN](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2015/aem-dispatcher-caching-new-features-and-optimizations.html?lang=en).
