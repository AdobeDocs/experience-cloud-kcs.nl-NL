...
4. Herstel de repository naar deze revisie door te bewerken.
   ...
   Verwijder alle regels na de regel met de laatste goede revisie. Als u wilt weten op welke datum en tijd u de opslagplaats terugkeert aan, stel dit bevel in de segmentstore omslag in werking (vervang afdb922d-ba53-4a1b-aa1b-1cb044b535cf met de recentste goede revisie in uw journaal.log):
...
*Let op:*De onderstaande procedure is bedoeld voor energiegebruikers.  Wanneer het schrappen van de corrupte knopen moet u ervoor zorgen zij geen systeemknopen (zoals /home, /jcr:system, enz.) zijn.  Of als het systeemknooppunten zijn, moet u ervoor zorgen dat u ze kunt herstellen.  Raadpleeg AEM Customer Care-team voor hulp bij de hier beschreven stappen als u het niet zeker weet.
