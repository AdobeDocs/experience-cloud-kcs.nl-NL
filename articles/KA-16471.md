...
description: "Leer hoe u een Adobe Experience Cloud-publiek kunt maken."
...
In dit artikel wordt beschreven hoe u een Adobe Experience Cloud-publiek kunt maken.
...
In dit artikel wordt beschreven hoe u een Adobe Experience Cloud-publiek kunt maken en wordt algemeen advies gegeven voor veelvoorkomende gebruiksgevallen.
...
- Wat is het algemene comfortniveau en de ervaring met de interface?
...
| <b>Doel</b> | <b>AAM/publiek</b> | <b>Analytics</b> |
| --- | --- | --- |
...
<b><u>PUBLICERINGSBIBLIOTHEEK</u></b>
...
<b>*Opmerking:* De samengestelde publiekslatentie is gelijk aan de latentie van het langzaamste publiek dat in het samengestelde publiek wordt gebruikt.</b>
...
Als er vragen zijn zoals: &quot;Heeft de persoon onlangs mijn site verlaten?&quot; of &quot;Heeft de persoon een product in de afgelopen dagen doorzocht of bekeken?&quot;, is het historische publiek de beste optie.
...
In de onderstaande tabel wordt een overzicht gegeven van de voor- en nadelen, de latentieomstandigheden, de geschiktheid van de gebruikerskenmerken en de limieten:
...
| Gebruikerskenmerken | Ja | Nee | Nee, maar u kunt CRM-gegevens laden voor een vergelijkbaar effect | Ja |
...
Als u vragen hebt over deze inhoud of het publiek in het Experience Cloud in het algemeen, gaat u naar de [Communautaire forums voor Experience League](https://experienceleaguecommunities.adobe.com).
